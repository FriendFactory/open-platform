...
function usage {
    >&2 echo "Error: $1"
    >&2 echo ""
    >&2 echo "Usage: MODE=(prod|test) [PARAM=value ...] $0 | cqlsh"
    >&2 echo ""
    ...
    >&2 echo "  TRACE_TTL          - time to live for trace data, in seconds (default: 432000, 5 days)"
...
trace_ttl=${TRACE_TTL:-432000}
dependencies_ttl=${DEPENDENCIES_TTL:-0}

template=$(dirname $0)/jaeger-schema.cql.tmpl
